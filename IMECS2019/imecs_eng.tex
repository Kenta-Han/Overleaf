...
% この場合，以前の経験は既に訪れたスポットであり，現在の問題は未訪問スポットである．
...
Finally, we associate the visited spot with the unfamiliar spot by the similarity of the relative feature vector, and further extract keywords that explain the relation.
% これにより，未訪問スポットのわかりやすさを向上させることを目指す．
...
% 本稿では，2016年9月末までの「Jalan」から得られたレビューデータを使用する．
...
% 表\ref{table:Familiar spots and Unfamiliar spots}は，ユーザ既訪問スポット集合と未訪問スポットの集合の例を示している．
